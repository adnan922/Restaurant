...
export default function MenuPage() {
  return (
    <div className="flex flex-col min-h-screen bg-zinc-50">
      ...
      {/* Hero Section */}
      <section className="relative h-[40vh] min-h-[300px] flex items-center justify-center text-center mt-20 overflow-hidden">
          ...
          <div key={index} className="mb-20 last:mb-0">
            ...
            <div className="grid md:grid-cols-2 gap-x-8 gap-y-6">
              {menu.items.map((item, itemIdx) => (
                <FadeIn key={itemIdx} direction="up" delay={itemIdx * 0.1}>
                  <div className="flex bg-white p-3 rounded-lg shadow-sm border border-zinc-100 hover:shadow-md transition duration-300">
                    ...
                    <div className="ml-4 flex flex-col justify-center w-full">
                      <div className="flex justify-between items-baseline mb-2">
                        <h3 className="font-playfair font-bold text-lg text-zinc-900">
                          {item.name}
                        </h3>
      ...
      <section className="bg-white py-16 border-t border-zinc-200 text-center px-4 overflow-hidden">
        <FadeIn direction="up">
          <div className="max-w-2xl mx-auto">
            <h2 className="font-playfair text-3xl font-bold text-zinc-900 mb-4">
